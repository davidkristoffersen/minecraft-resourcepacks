...
Download: [`ThemeHorror-2.2.0.zip`](ThemeHorror-2.2.0.zip)
...
- the frost border of the `frozen` cue (vanilla's powder-snow outline) as veins of
  blood closing in from the edges;
